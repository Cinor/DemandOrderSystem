...
namespace DemandOrderSystem.Models
{
    ...
    public partial class Question
    {
        ...
        public Nullable<int> ReqCount { get; set; }
        public Nullable<int> AcceptanceCount { get; set; }
        public Nullable<int> MailCount1 { get; set; }
        public Nullable<int> MailCount2 { get; set; }
