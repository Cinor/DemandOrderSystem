...
namespace DemandOrderSystem.Service
{
    public class DBService
    {
        ...
        /// <returns></returns>
        public IQueryable<TableSeven> getSevenTable(DateTime caseCloseDate, DateTime dischargeDate)
        {
            ...
            IQueryable<TableSeven> viewREQ = from REQ in _db.Request
